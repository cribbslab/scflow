...
The first stage of the pipeline is to create a seurat object by running the Scanpy workflow jupyter notebook.
...
for (i in samples){
  ...
  metrics <- readRDS(gsub("SAMPLE_FILE",i , "SALMPLE_FILE_metrics_clean_mouse1.rds"))
...
for (i in samples){
  ...
  cat("## ",i,"\n")
  print(VlnPlot(so, features = c("nFeature_RNA", "nUMI","nCount_RNA", "percent.mt"), ncol = 3))
  cat('\n\n')
}
```
