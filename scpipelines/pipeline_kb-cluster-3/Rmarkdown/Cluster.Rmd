...
sample_files <- str_replace(Sys.glob("RDS_objects.dir/*_clustered_filtered_SeuratObject.rds"), "RDS_objects.dir/", "")
# Sample names
sample_names <- gsub("_clustered_filtered_SeuratObject.rds", "", sample_files)
```
...
for (i in sample_names){
  name <- paste0("RDS_objects.dir/", i, "_clustered_filtered_SeuratObject.rds")
  so <- readRDS(name)
