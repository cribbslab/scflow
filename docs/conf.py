...
project = 'single_cell'
copyright = '2018, Adam Cribbs'
author = 'Adam Cribbs, Anna James-Bott'
...
texinfo_documents = [
    (master_doc, 'single_cell', 'single_cell Documentation',
     author, 'Adam Cribbs', 'Single cell analysis pipelines.'),
]
